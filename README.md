...
## Local MLX Whisper STT (Apple Silicon)

This project includes a local MLX Whisper STT service optimized for Apple Silicon (M1/M2/M3). The service uses the [mlx-community/whisper-large-v3-mlx](https://huggingface.co/mlx-community/whisper-large-v3-mlx) model.

### Quick Start

1. **Set up the Whisper service:**
   ```bash
...
3. **The agent is already configured** to use the local service when it's running on port 9000.

For detailed setup instructions, see [whisper-service/SETUP.md](whisper-service/SETUP.md).
